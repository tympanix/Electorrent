...
const electorrentBridge: ElectorrentBridge = {
    ...
    bittorrent: {
        ...
        setSelectedTorrents: (ids) => invoke(IPC_CHANNELS.bittorrent.setSelectedTorrents, { ids }),
        ...
        addTorrentTracker: (request) => invoke(IPC_CHANNELS.bittorrent.addTorrentTracker, request),
        editTorrentTracker: (request) => invoke(IPC_CHANNELS.bittorrent.editTorrentTracker, request),
        removeTorrentTracker: (request) => invoke(IPC_CHANNELS.bittorrent.removeTorrentTracker, request),
