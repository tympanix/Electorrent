...
angular.module('torrentApp').factory('TorrentD', ['AbstractTorrent', function(AbstractTorrent) {
    ...
    function TorrentD(hash, data) {
        ...
        AbstractTorrent.call(this, {
            ...
            percent: data.progress*1000, /* Percent (integer): completion in per-mille (100% = 1000)  */
