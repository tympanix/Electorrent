    ...
    async getTorrentDetails(hash: string): Promise<BittorrentTorrentDetailsData> {
        ...
        return {
            info: {
                ...
                allTimeDownloaded: details.all_time_download ?? null,
                payloadDownloaded: details.total_payload_download ?? null,
                payloadUploaded: details.total_payload_upload ?? null,
                totalRemaining: details.total_remaining ?? null,
                finishedTime: details.finished_time ?? null,
                storageMode: details.storage_mode ?? null,
                autoManaged: details.is_auto_managed ?? details.auto_managed ?? null,
                finished: details.is_finished ?? null,
                seed: details.is_seed ?? null,
                maxUploadSlots: details.max_upload_slots ?? null,
                moveCompleted: details.move_completed ?? null,
                moveCompletedPath: details.move_completed_path ?? null,
                nextAnnounce: details.next_announce ?? null,
                prioritizeFirstLast: details.prioritize_first_last_pieces ?? null,
                sequentialDownload: details.sequential_download ?? null,
                shared: details.shared ?? null,
                removeAtRatio: details.remove_at_ratio ?? null,
                seedMode: details.seed_mode ?? null,
                private: details.private ?? null,
                numFiles: details.num_files ?? null,
                tracker: details.tracker ?? null,
                trackerStatus: details.tracker_status ?? null,
                comment: details.comment ?? null,
                creator: details.creator ?? null,
                timeSinceDownload: details.time_since_download ?? null,
                timeSinceUpload: details.time_since_upload ?? null,
            },
        }
    }
