...
export class RtorrentRuntime implements BittorrentRuntime {
    ...
    async getSnapshot(): Promise<any> {
        ...
        for (const torrent of torrents) {
            stringsToBooleans(torrent, ["active", "open", "complete", "hashing", "hashed", "private"])
    ...
    async getTorrentDetails(hash: string): Promise<BittorrentTorrentDetailsData> {
        const detailCommands: Record<string, RtorrentMulticallCommand> = {
            ...
            torrentFile: "d.tied_to_file",
            sessionFile: "d.loaded_file",
            name: "d.name",
            totalSize: "d.size_bytes",
            creationDate: "d.creation_date",
            pieceSize: "d.chunk_size",
            piecesTotal: "d.size_chunks",
            filesTotal: "d.size_files",
            wantedPieces: "d.wanted_chunks",
            totalDownloaded: "d.down.total",
            totalUploaded: "d.up.total",
            skippedTotal: "d.skip.total",
            skippedSpeed: "d.skip.rate",
            downloadSpeed: "d.down.rate",
            uploadSpeed: "d.up.rate",
            leftBytes: "d.left_bytes",
            throttleName: "d.throttle_name",
            groupName: "d.group.name",
            priority: "d.priority_str",
            connectionType: "d.connection_current",
            label: "d.custom1",
            chunksComplete: "d.completed_chunks",
            message: "d.message",
            peers: "d.peers_accounted",
            peersPending: "d.peers_not_connected",
            seeds: "d.peers_complete",
            peersMin: "d.peers_min",
            peersMax: "d.peers_max",
            uploadsMin: "d.uploads_min",
            uploadsMax: "d.uploads_max",
            downloadsMin: "d.downloads_min",
            downloadsMax: "d.downloads_max",
            isPrivate: "d.is_private",
            isMultiFile: "d.is_multi_file",
            peerExchange: "d.peer_exchange",
            peerExchangeActive: "d.is_pex_active",
            freeDiskSpace: "d.free_diskspace",
            additionDate: ["d.custom", "addtime"],
            loadDate: "d.load_date",
            startDate: "d.timestamp.started",
            completionDate: "d.timestamp.finished",
            stateChangedDate: "d.state_changed",
        }
        ...
        return {
            info: {
                ...
                basePath: typeof detailFields.basePath === "string" ? detailFields.basePath : null,
                torrentFile: typeof detailFields.torrentFile === "string" ? detailFields.torrentFile : null,
                sessionFile: typeof detailFields.sessionFile === "string" ? detailFields.sessionFile : null,
                creationDate: creationDate ?? null,
                pieceSize: pieceSize ?? null,
                piecesTotal: detailFields.piecesTotal,
                filesTotal: detailFields.filesTotal,
                wantedPieces: detailFields.wantedPieces,
                totalDownloaded: totalDownloaded ?? null,
                totalUploaded: totalUploaded ?? null,
                skippedTotal: detailFields.skippedTotal,
                skippedSpeed: detailFields.skippedSpeed,
                leftBytes: leftBytes ?? null,
                shareRatio: ratio,
                additionDate: additionDate ?? null,
                loadDate: loadDate ?? null,
                startDate: detailFields.startDate,
                completionDate: detailFields.completionDate,
                stateChangedDate: detailFields.stateChangedDate,
                downloadSpeed: downloadSpeed ?? null,
                eta: downloadSpeed > 0 ? (leftBytes ?? 0) / downloadSpeed : null,
                peers: peers ?? null,
                peersPending: detailFields.peersPending,
                seeds: seeds ?? null,
                peersMin: detailFields.peersMin,
                peersMax: detailFields.peersMax,
                uploadsMin: detailFields.uploadsMin,
                uploadsMax: detailFields.uploadsMax,
                downloadsMin: detailFields.downloadsMin,
                downloadsMax: detailFields.downloadsMax,
                totalSize: totalSize ?? null,
                freeDiskSpace: detailFields.freeDiskSpace,
                ...
                groupName: typeof detailFields.groupName === "string" ? detailFields.groupName : null,
                throttleName: typeof detailFields.throttleName === "string" ? detailFields.throttleName : null,
                priority: typeof detailFields.priority === "string" ? detailFields.priority : null,
                connectionType: typeof detailFields.connectionType === "string" ? detailFields.connectionType : null,
                isPrivate: detailFields.isPrivate == null ? null : detailFields.isPrivate !== 0,
                isMultiFile: detailFields.isMultiFile == null ? null : detailFields.isMultiFile !== 0,
                peerExchange: detailFields.peerExchange == null ? null : detailFields.peerExchange !== 0,
                peerExchangeActive: detailFields.peerExchangeActive == null ? null : detailFields.peerExchangeActive !== 0,
